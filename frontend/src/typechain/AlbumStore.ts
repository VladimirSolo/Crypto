...
export declare namespace AlbumStore {
...
export interface AlbumStoreInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addAlbum"
      | "albums"
...
export interface AlbumStore extends BaseContract {
  connect(runner?: ContractRunner | null): AlbumStore;
  ...
  allAlbums: TypedContractMethod<[], [AlbumStore.AlbumStructOutput[]], "view">;
  ...
  ): TypedContractMethod<[], [AlbumStore.AlbumStructOutput[]], "view">;
  getFunction(
    nameOrSignature: "buy"
